...
shareN = 2000
shareC = 40
shareP = shareN * shareC
print('The amount of money Joe paid for the stock = $', shareP)

comm1 = shareP * 0.03
print('The amount of commission Joe paid his broker when he bought the stock = $', comm1)

shareNC = 42.75
shareNP = shareN * shareNC
print('The amount for which Joe sold the stock = $', shareNP)

comm2 = shareNP * 0.03
print('The amount of commission Joe paid his broker when he sold the stock = $', comm2)

total = shareNP - (shareP + comm1 + comm2)
print('The  amount of money that Joe had left when he sold the stock and paid his broker (both times) = $', total)